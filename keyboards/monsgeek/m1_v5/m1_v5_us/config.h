...
#define UART_TX_PIN                         C10 //added
#define UART_RX_PIN                         C11 //added
#define UART_RX_PAL_MODE                    7 // For chibiOS GPIO configuration
...
// Open for anyone to fix, let me know if you do
// Until then, I'll try to work on it.
